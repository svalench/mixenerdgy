...
<div class="container">
  ...
  <div class="row" style="padding-top:50px; ">
    ...
    <h1 style="font-size: 20px; color: #0d82d3;">ООО «МиксЭнерджи»</h1><span style="font-size: 18px;">
    основано в 2019 году. Основным направлением нашей деятельности является оптовая поставка
...
<h3 style="font-size: 20px;color: #0d82d3;">
